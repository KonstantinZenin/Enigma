...
from .forms import RegistrationForm, ProfileEditForm, LoginForm, CustomClearableFileInput
from characters.models import GameCharacter  # Вынесен импорт в начало
